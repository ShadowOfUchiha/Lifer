...
<h2><?php echo __('Media Statistics', 'powerpress'); ?></h2>
	...
	<div>
        ...
        <div id="stats-prefix-notice" class="card alert alert-danger p-3">
            ...
            <p><b>Before setting a statistics redirect, please carefully read the criteria below.</b></p>
            <ul>
    ...
    <div class="pp-settings-program-summary">
        ...
        <div class="prog-sum-contents">
            ...
            <div class="pp-settings-podcast-status">
                ...
                <?php } ?>
                    <p id="pp-welcome-applesubmit-link" class="program-dest-welcome-link" onclick="goToDestinationSettings();return false;"><img src="<?php echo powerpress_get_root_url(); ?>images/status_incomplete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Not done', 'powerpress'); ?>" />Set Destination Links</p>
            </div>
        </div>
    </div>
